...
from pytorch_pretrained_bert.modeling import RobertaForSequenceClassification, RobertaConfig, WEIGHTS_NAME, CONFIG_NAME
...
def main():
    ...
    if args.do_train:
        train_examples = processor.get_train_examples(args.data_dir) #NOTE: HERE IS THE DATA PULL-IN
